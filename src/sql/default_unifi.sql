...
CREATE TABLE Vehicle (
    ...
    state VARCHAR(20) NOT NULL DEFAULT 'WORKING', -- AVAILABLE, IN_USE, MAINTENANCE
...
INSERT INTO Vehicle (id, capacity, state, location) VALUES
 (1,4, 'WORKING', 1),
 (2,4, 'WORKING', 2),
 (3,4, 'MAINTENANCE', 3),
 (4,7, 'WORKING', 4),
 ...
 INSERT INTO "User" (id, name, surname, email, password, license) VALUES
(7076614, 'Edoardo', 'Rustichini', 'rustichini@prova.com', 'passedo', 'patenterustic'),
(7072924, 'Tommaso', 'Bellucci', 'bellucci@prova.com', 'passtomm', 'patentebellu'),
 (7079207, 'Tiziano', 'Talini', 'talini@prova.com', 'passtiz', 'patentetizi');


INSERT INTO Trip (origin, destination, date, time, state, driver, vehicle) VALUES
 (1, 2, '2024-06-20', '10:00', 'SCHEDULED', 7076614, 1),
 (3, 4, '2024-06-21', '09:00', 'SCHEDULED', 7072924, 4),
 (5, 6, '2024-06-22', '11:00', 'SCHEDULED', 7079207, 11);

INSERT INTO "User" (id, name, surname, email, password, role) VALUES
(1, 'Admin', 'Admin', 'admin@prova.com', 'adminpass', 'ADMIN');